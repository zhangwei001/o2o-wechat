				...
				Vue.component('wechatinfo',{
					...
					data:function(){
						return {
							...
							"downLoadCodeImg":download_url+content.qr_file_image,
							"upgradeLink":webRoot+"/route/"+shopSid+"/help-wechat_help_center#upgrade",
							"authLink":webRoot+"/route/"+shopSid+"/help-wechat_help_center#auth",
