...
Date.prototype.format = function(style) {
	...
	if($("#controlTarg").val()==1){
	setTimeout("rendTo();",500);
	}
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;display:none;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:216px;">');
